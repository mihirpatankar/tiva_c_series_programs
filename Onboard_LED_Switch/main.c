...
int main(){
    ...
    while(1){
      ...
      case 0x00:GPIO_PORTF_DATA_R=RED_LED;
      break;
      
      case 0x01:GPIO_PORTF_DATA_R=GREEN_LED;
      break;
      
      case 0x10:GPIO_PORTF_DATA_R=BLUE_LED;
      break;
      
      default:GPIO_PORTF_DATA_R &= ~(RED_LED | BLUE_LED | GREEN_LED);
      break;
      }
    }  
    return 0;
